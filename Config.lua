	...
	args = {
		...
		icons = {
			...
			args = {
				desc = {
					type = "description",
					name = L["Options which affect the look and behaviour of the icons"],
					disabled = false,
					order = 0.1,
				},
				debugIcons = {
		...
		bars = {
			...
			args = {
				desc = {
					type = "description",
					name = L["Options which affect the look and behaviour of the bars"],
					disabled = false,
					order = 0.1,
				},
				debugBars = {
		...
		cooldowns = {
			...
			args = {
				desc = {
					type = "description",
					name = L["To announce in the chat about the readiness of cooldowns, press shift + left click on the icon or timer"],
					disabled = false,
					order = 0.1,
				},
			}
